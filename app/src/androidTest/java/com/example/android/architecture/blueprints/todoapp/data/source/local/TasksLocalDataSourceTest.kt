...
class TasksLocalDataSourceTest {
    ...
    //
    //The only real difference from the analogous DAO test is that the local data source returns
    // an instance of the sealed Result class, which is the format the repository expects.
    // For example, this line here casts the result as a Success:
    @Test
